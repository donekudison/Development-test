...
```
git clone https://github.com/stelligent/miniproject-EDINGE-ELVIS.git
```
...
```
$ cd miniproject-EDINGE-ELVIS
```
# To Lunch Environment, run the below command
```
$ ansible-playbook -i inventory assignment/webserver.yml --sudo
